...
const getPlataformas = async (req, res, next) => {
    ...
    try {
        ...
        const allPlataformasDB = await Plataforma.find();
        ...
        return next("No se han podido solicitar las plataformas a la base de datos", error)
    }
...
const getPlataformaById = async (req, res, next) => {
    ...
    try {
        ...
        if (!plataformaDB) {
            return next("No se encuentra la plataforma a la que usted está tratando de dar búsqueda.")
        }
...
const getPlataformaByTitulo = async (req, res, next) => {
    ...
    try {
        ...
        if (!plataformaDB) {
            return next("No se encuentra la unidad de plataforma a la que usted está tratando de dar búsqueda.")
        }
...
const patchPlataforma = async (req, res, next) => {
    ...
    try {
        ...
        return res.statu(200).json({ new: patchPlataformaDB, old: PlataformaDB });
